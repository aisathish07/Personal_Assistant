...
class SettingsDialog:
    ...
    def create_api_tab(self, parent):
        ...
        ctk.CTkLabel(
            frame,
            text="🔑 Configure API Keys for External Services",
            font=("Arial", 14, "bold")
        ).pack(pady=(0, 20))
        
        # Gemini API Key (Required)
        ctk.CTkLabel(frame, text="Gemini API Key (Required)", anchor="w").pack(fill="x", pady=(0, 5))
        ...
        ctk.CTkLabel(frame, text="ElevenLabs API Key (Optional - Better TTS)", anchor="w").pack(fill="x", pady=(0, 5))
        ...
        ctk.CTkLabel(frame, text="OpenWeatherMap API Key (Optional)", anchor="w").pack(fill="x", pady=(0, 5))
        ...
        ctk.CTkCheckBox(
            frame,
            text="🔒 Local Only Mode (No external API calls)",
    ...
    def create_performance_tab(self, parent):
        ...
        # Web Agent Mode
        ctk.CTkLabel(frame, text="Web Agent Performance Mode:", anchor="w", font=("Arial", 12, "bold")).pack(fill="x", pady=(0, 5))
        ...
        # Whisper Model
        ctk.CTkLabel(frame, text="Speech Recognition Model:", anchor="w", font=("Arial", 12, "bold")).pack(fill="x", pady=(15, 5))
        ...
        ctk.CTkCheckBox(
            frame,
            text="🌐 Enable Web Agent (browser automation)",
    ...
    def create_behavior_tab(self, parent):
        ...
        ctk.CTkLabel(
            frame,
            text="🎭 Assistant Behavior Settings",
            font=("Arial", 14, "bold")
        ).pack(pady=(0, 20))
        
        # TTS Priority
        ctk.CTkLabel(frame, text="Text-to-Speech Priority:", anchor="w", font=("Arial", 12, "bold")).pack(fill="x", pady=(0, 5))
        
        tts_frame = ctk.CTkFrame(frame)
        tts_frame.pack(fill="x", pady=(0, 15))
        
        ctk.CTkLabel(tts_frame, text="Drag to reorder (highest priority first):", anchor="w").pack(fill="x", padx=10, pady=5)
        ...
        ctk.CTkCheckBox(tts_frame, text="🎤 ElevenLabs (Best quality, requires API key)", variable=self.tts_vars["elevenlabs"]).pack(anchor="w", padx=10, pady=3)
        ctk.CTkCheckBox(tts_frame, text="🌐 Google TTS (Online, free)", variable=self.tts_vars["gtts"]).pack(anchor="w", padx=10, pady=3)
        ctk.CTkCheckBox(tts_frame, text="🔧 Piper (Offline, local)", variable=self.tts_vars["piper"]).pack(anchor="w", padx=10, pady=3)
        ...
        ctk.CTkLabel(frame, text="Global Hotkey:", anchor="w", font=("Arial", 12, "bold")).pack(fill="x", pady=(15, 5))
        ctk.CTkLabel(frame, text="Ctrl+Space (click floating orb to change)", anchor="w", text_color="gray").pack(fill="x", pady=(0, 15))
    ...
    def create_advanced_tab(self, parent):
        ...
        ctk.CTkLabel(info_frame, text="System Information:", font=("Arial", 12, "bold")).pack(anchor="w", padx=10, pady=(10, 5))
        ...
        ctk.CTkLabel(info_frame, text=info_text, anchor="w", justify="left").pack(anchor="w", padx=20, pady=(0, 10))
        
        # Cache Management
        ctk.CTkLabel(frame, text="Cache Management:", font=("Arial", 12, "bold")).pack(fill="x", pady=(15, 5))
        ...
        ctk.CTkButton(
            cache_frame,
            text="🗑️ Clear Web Cache",
            command=self.clear_web_cache,
            width=180
        ).pack(side="left", padx=10, pady=10)
        
        # Logs
        ctk.CTkLabel(frame, text="Logs & Diagnostics:", font=("Arial", 12, "bold")).pack(fill="x", pady=(15, 5))
        ...
        # Database
        ctk.CTkLabel(frame, text="Database:", font=("Arial", 12, "bold")).pack(fill="x", pady=(15, 5))
